...
# MAGIC
# MAGIC
# MAGIC Switch to Databricks SQL to see how this data can easily be requested using <a  dbdemos-dashboard-id="churn-universal" href='/sql/dashboardsv3/01ef54d7f4f71c489e7c7f773f81fb58' target="_blank">Churn prediction DBSQL dashboard</a>, or an external BI tool. 
# MAGIC
