...
--%python
--display(spark.read.json('/Volumes/main/dbdemos_retail_c360/c360/users'))

-- COMMAND ----------

-- DBTITLE 1,Raw incoming orders (json)
--%python
--display(spark.read.json('/Volumes/main/dbdemos_retail_c360/c360/orders'))

-- COMMAND ----------

-- DBTITLE 1,Raw incoming clickstream (csv)
--%python
--display(spark.read.csv('/Volumes/main/dbdemos_retail_c360/c360/events', header=True))
